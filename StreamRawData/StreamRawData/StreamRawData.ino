...
int nActiveChannels = 2;   //how many active channels would I like?
...
//////#define SAMPLE_RATE_HZ (500.0)  //default setting for ECG *
...
#define HP_CUTOFF_HZ (0.05)  //set the desired cutoff for the highpass filter
...
boolean useFilters = true;  //enable or disable as you'd like...turn off if you're daisy chaining!
